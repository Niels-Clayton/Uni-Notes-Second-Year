...
\begin{document}
\title{\LARGE{\textbf{ECEN 220 Lab 5}}}
...
\begin{figure}[h]
 \begin{center}
  \fbox{\includegraphics[width = \textwidth]{1_shift.png}}
...
\begin{figure}[h]
 \begin{center}
  \fbox{\includegraphics[width = 0.9\textwidth]{3_1.png}}
...
\begin{figure}[h]
 \begin{center}
 \vspace{-10pt}
  \fbox{\includegraphics[width = .8\textwidth]{3_2_5.png}}
...
\begin{figure}[h]
 \begin{center}
  \fbox{\includegraphics[width = 0.8\textwidth]{filter_5.png}}
  \caption{DTFT of temperature data}
  \vspace{-20pt}
 \end{center}
\end{figure}
...
\begin{figure}[h]
 \begin{center}
 \vspace{-10pt}
  \fbox{\includegraphics[width = .8\textwidth]{filter_10.png}}
  \caption{Comparison of un-filtered and filtered data}
  \vspace{-30pt}
 \end{center}
\end{figure}
...
\begin{figure}[h]
 \begin{center}
  \fbox{\includegraphics[width = 0.7\textwidth]{high.png}}
  \caption{DTFT of temperature data}
  \vspace{-20pt}
 \end{center}
\end{figure}
...
\begin{figure}[h]
 \begin{center}
 \vspace{-10pt}
  \fbox{\includegraphics[width = .7\textwidth]{low.png}}
  \caption{Comparison of un-filtered and filtered data}
  \vspace{-30pt}
 \end{center}
\end{figure}
